...
- has_adults: one of {ALLOWED['has_adults']}. This asks whether ADULTS ARE THE DIRECT STUDY SUBJECTS, not merely whether some adult is mentioned. "yes" if adults aged 18+ are themselves direct participants — the people receiving the intervention or being assessed/interviewed. "no" if the participants are entirely under 18, OR the only adults present are parents, caregivers, family members, teachers, or clinicians OF an otherwise child/adolescent sample (the studied subjects are the children — parents acting as informants or as parent-training recipients do NOT make has_adults=yes). "{UNSPECIFIED}" if no age/subject information is given.
...
6) "An RCT of clinician-delivered Behavioural Parent Training for parents of children with ADHD." -> the parents are trained as a route to help their CHILD; the studied subjects of interest are the children, and the parents are mediators/recipients, not adult subjects with the condition -> intervention_type=parent_training, has_adults=no (adults are not the direct subjects), has_under_18=yes (children), study_type=empirical_with_results.
7) "Neurofeedback for 13 children with ADHD aged 7-13; outcomes rated by parents." -> the subjects are children; parents are only informants -> has_adults=no, has_under_18=yes, intervention_type=neurofeedback, neurotypes=adhd, study_type=empirical_with_results.
...
- has_adults: one of {SCREEN_ALLOWED['has_adults']}. This asks whether ADULTS ARE THE DIRECT STUDY SUBJECTS, not merely whether an adult is mentioned. "yes" if adults aged 18+ are themselves direct participants (receiving the intervention or being assessed). "no" if participants are entirely under 18, OR the only adults present are parents, caregivers, family, teachers, or clinicians OF a child/adolescent sample (the studied subjects are the children — parents as informants or parent-training recipients do NOT count as has_adults=yes). "{UNSPECIFIED}" if no age/subject information at all.
